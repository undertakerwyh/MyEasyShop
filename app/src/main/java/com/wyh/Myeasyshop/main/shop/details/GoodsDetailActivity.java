...
public class GoodsDetailActivity extends MvpActivity<GoodsDetailView, GoodsDetailPresenter> implements com.wyh.Myeasyshop.main.shop.details.GoodsDetailView {
    ...
    private com.wyh.Myeasyshop.main.shop.details.GoodsDetailAdapter adapter;
    ...
    public void onContentChanged() {
        ...
        list = new ArrayList<>();
        adapter = new com.wyh.Myeasyshop.main.shop.details.GoodsDetailAdapter(list);
        ...
        /*ViewPager的Item单击事件*/
        adapter.setListener(new com.wyh.Myeasyshop.main.shop.details.GoodsDetailAdapter.OnItemClickListener() {
            @Override
            public void onItemClick() {
                //点击图片，跳转到图片展示的avitivty
                Intent intent = com.wyh.Myeasyshop.main.shop.details.GoodsDetailInfoActivity.getStartIntent(GoodsDetailActivity.this, list_uri);
    ...
    @NonNull
    @Override
    public com.wyh.Myeasyshop.main.shop.details.GoodsDetailPresenter createPresenter() {
        return new com.wyh.Myeasyshop.main.shop.details.GoodsDetailPresenter();
    }

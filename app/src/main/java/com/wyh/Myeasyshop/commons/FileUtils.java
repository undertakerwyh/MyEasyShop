...
final class FileUtils {
    ...
    public static void deleteIgnoringFailure(final File file) {
        ...
        if (!success) {
            com.wyh.Myeasyshop.commons.LogUtils.i("Could not delete " + file.getAbsolutePath());
        }
    }
    ...
    public static boolean delete(final File file) {
        final boolean success = file.delete() || !file.exists();
        if (!success) {
            com.wyh.Myeasyshop.commons.LogUtils.e("Could not delete " + file.getAbsolutePath());
        }
        return success;
    }
    ...
    public static boolean mkdirs(final File file) {
        ...
        if (!success) {
            com.wyh.Myeasyshop.commons.LogUtils.e("Could not make directories " + file.getAbsolutePath());
        }
        return success;
    }

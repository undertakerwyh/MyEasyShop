...
public class CachePreferences {
    ...
    public static void setUser(com.wyh.Myeasyshop.model.User user) {
    ...
    public static com.wyh.Myeasyshop.model.User getUser() {
        com.wyh.Myeasyshop.model.User user = new com.wyh.Myeasyshop.model.User();
